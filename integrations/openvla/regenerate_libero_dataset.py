...
def main(args):
    ...
    task_suite = benchmark_dict[args.libero_task_suite]()  # where benchmark class is instantiated
...
if __name__ == "__main__":
    ...
    parser.add_argument("--libero_task_suite", type=str, choices=["libero_spatial", "libero_object", "libero_goal", "libero_10", "libero_90", "bl3_all"],
    ...
    parser.add_argument("--libero_raw_data_dir", type=str,
                        ...
                        default="libero/datasets/boss_44")
    parser.add_argument("--libero_target_dir", type=str,
                        ...
                        default="libero/datasets/boss_44_openvla_no_noops")
